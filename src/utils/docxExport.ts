    ...
    const doc = new Document({
      sections: [{
        ...
        children: [
          ...
          new Paragraph({
            children: [new TextRun({
              text: `${isPatientCopy ? (translatedContent?.reportGeneratedBy || "Report generated by NHS Translation Tool") : "Report generated by NHS Translation Tool"} - ${new Date().toLocaleString('en-GB')}`,
              size: 18,
              italics: true
            })],
            alignment: AlignmentType.CENTER
