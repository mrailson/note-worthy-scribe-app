...
export const handlers: Record<string, (ctx: QuickPickContext) => Promise<void> | Promise<string> | string> = {
  ...
  // Meeting Notes Service handlers
  "meeting-notes-formal-board": meetingNotesFormalBoard,
  "meeting-notes-informal-team": meetingNotesInformalTeam,
  "meeting-notes-agenda-based": meetingNotesAgendaBased,
  "meeting-notes-narrative": meetingNotesNarrative,
  "meeting-notes-resolution": meetingNotesResolution,
  "meeting-notes-brainstorming": meetingNotesBrainstorming,
  "meeting-notes-hr": meetingNotesHR,
