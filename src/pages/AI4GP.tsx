...
const AI4GP = () => {
  ...
  return (
    <div className="h-screen bg-background flex flex-col ai4gp-no-transform safe-area-top safe-area-bottom">
      <SEO 
      ...
      <main className="flex-1 flex flex-col min-h-0 mobile-scroll overflow-x-hidden">
        <div className="flex-1 w-full max-w-[1536px] mx-auto px-0 sm:px-2 xl:px-6 2xl:px-8 py-0 xl:py-4 flex flex-col min-h-0 overflow-hidden">
          <MaintenanceBanner />
