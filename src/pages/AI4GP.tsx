  ...
  return (
    <div className="min-h-screen bg-background flex flex-col mobile-container safe-area-top safe-area-bottom">
      ...
      <main className="flex-1 flex flex-col min-h-0 mobile-scroll">
        <div className="flex-1 mx-auto px-2 sm:px-4 py-4 sm:py-6 flex flex-col min-h-0 overflow-y-auto space-y-6" style={{width: 'calc(100vw - 220px)', maxWidth: 'calc(100vw - 220px)'}}>
          <AI4GPService />
        </div>
