...
const PrivacyNotice = () => {
  ...
  const handlePrint = () => {
    const iframe = document.getElementById('privacy-notice-iframe') as HTMLIFrameElement;
  ...
  const handleDownload = () => {
    ...
    link.href = '/documents/privacy-notice.html';
    link.download = 'privacy-notice.html';
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex items-center gap-2 px-4 py-2 border-b flex-wrap">
        ...
        <h1 className="text-lg font-semibold flex-1">Privacy Notice</h1>
      ...
      <div className="flex-1 overflow-auto">
        <iframe
          id="privacy-notice-iframe"
          src="/documents/privacy-notice.html"
          className="border-0"
