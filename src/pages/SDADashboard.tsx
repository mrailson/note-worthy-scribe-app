...
const tabs = [
  ...
  { value: "hours", label: "SDA Claims", shortLabel: "Claims", icon: PoundSterling },
  { value: "time-tracker", label: "Part B Time Tracker", shortLabel: "Part B", icon: Timer },
