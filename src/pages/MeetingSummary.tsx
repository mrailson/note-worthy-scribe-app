...
Generated by Notewell AI Meeting Notes Service`;
  ...
  const loadExistingSummary = async (meetingId: string) => {
    try {
      ...
      if (summary?.summary) {
        setAiGeneratedMinutes(summary.summary);
    ...
    <div className="min-h-screen bg-background px-3 py-4 sm:p-6">
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
        ...
        <div className="space-y-3">
          ...
          {/* Continue Meeting Button - Mobile Friendly */}
        ...
        {/* Desktop/Mobile Stats and AI Generation */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="p-6">
            <div className="space-y-4">
              <Button 
                onClick={() => generateAIMeetingMinutes()} 
                disabled={!meetingData.transcript || isGeneratingMinutes}
                className="w-full h-auto p-6 relative overflow-hidden group"
                size="lg"
              >
                <div className="flex flex-col items-center gap-2 relative z-10">
                  ...
                  <span className="text-xs opacity-80">
                    {isGeneratingMinutes ? 'This may take up to 30 seconds' : 'Generate meeting minutes with AI first to enable email sharing'}
                  </span>
                </div>
              </Button>
              
              {/* Email Button - Show after AI generation */}
                    ...
                    <div className="space-y-4 flex-1 overflow-y-auto min-h-0">
                        ...
                        <div className="space-y-2 mt-2">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="includeTranscriptInEmail" className="text-sm">
                              Include Full Transcript in Email Body
                            </Label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-2">
                          <Button onClick={downloadDocx} variant="outline" className="w-full justify-start">
          ...
          <Card className="p-6">
            ...
            <div className="text-center">
              <h3 className="text-lg font-semibold mb-2">Words Recorded</h3>
              <p className="text-3xl font-bold text-primary">{meetingData.wordCount}</p>
            </div>
          </Card>
        </div>
