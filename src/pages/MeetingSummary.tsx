                        ...
                        <Button
                          ...
                          onClick={async (e) => {
                            ...
                            try {
                              ...
                              if (meetingData?.id) {
                                console.log('💾 Saving cleaned transcript to database...');
                                
                                // Save cleaned transcript back to database
                                ...
                                console.log('✅ Successfully saved cleaned transcript to database');
                                
                                // Update the meeting data with cleaned transcript
                                setMeetingData(prev => prev ? { ...prev, transcript: data.cleanedTranscript } : null);
                                
                                // Also refresh the transcript data to show the cleaned version
                                ...
                                toast.success('Transcript cleaned and saved successfully!');
                              } else {
                                // Just update the local state if no meeting ID
                                setMeetingData(prev => prev ? { ...prev, transcript: data.cleanedTranscript } : null);
