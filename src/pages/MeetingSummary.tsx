...
Generated by Notewell AI Meeting Notes Service`;
  ...
  const getMeetingDate = (): string => {
    ...
    // First try to extract from meetingData.startTime which should be available
    ...
    // Fallback: Prefer MeetingSettings date if provided
  ...
  const getMeetingRoundedTime = (): string => {
    ...
    // Fallback: Prefer MeetingSettings startTime if provided
                ...
                <div className="mt-2 space-y-2">
                  <div className="flex flex-wrap gap-4 text-xs sm:text-sm text-muted-foreground">
                    <span className="inline-flex items-center gap-1">
                      <span className="font-medium">Meeting Date:</span> {getMeetingDate()}
                    </span>
                    <span className="inline-flex items-center gap-1">
                      <span className="font-medium">Meeting Time:</span> {getMeetingRoundedTime()}
                    </span>
                    <span className="inline-flex items-center gap-1">
                      <span className="font-medium">Duration:</span> {meetingData?.duration}
                    </span>
                    <span className="inline-flex items-center gap-1">
                      <span className="font-medium">Words:</span> {meetingData?.wordCount ? `${(meetingData.wordCount / 1000).toFixed(1)}k` : '0'} words
                    </span>
                  </div>
