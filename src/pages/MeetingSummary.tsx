              ...
              <div className={practiceData?.logo_url ? '' : 'w-full'}>
                ...
                <div className="mt-2">
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    <span className="font-medium">Meeting:</span> {meetingData.title} | <span className="font-medium">Type:</span> {meetingSettings.meetingType.replace(/-/g, ' ').replace(/\b\w/g, l => l.toUpperCase())} | <span className="font-medium">Date & Time:</span> {(() => {
                      console.log('Meeting start time:', meetingData.startTime);
