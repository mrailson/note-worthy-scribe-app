...
export default function MeetingSummary() {
  ...
  const [isClaudeMinutesOpen, setIsClaudeMinutesOpen] = useState(false);
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {aiGeneratedMinutes ? (
            <>
              ...
              {/* Claude AI Meeting Minutes Section */}
              <Card>
                  ...
                  <CollapsibleTrigger asChild>
                    <CardHeader className="hover:bg-accent/50 transition-colors cursor-pointer">
                      <CardTitle className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          {claudeNotes && isClaudeMinutesOpen && (
                            <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-3">
                              <div className="flex items-center gap-2">
                                <Button
                                  onClick={(e) => {
                          ...
                          {!claudeNotes && (
                            ...
                            >
                              <Sparkles className="h-3 w-3 mr-1" />
                              {isClaudeGenerating ? "Generating..." : "Generate"}
                            </Button>
                          )}
                          <ChevronDown 
                    ...
                    <CardContent className="pt-0">
                      {claudeNotes ? (
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <Select value={claudeDetailLevel} onValueChange={handleClaudeDetailLevelChange}>
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="super">Maximum</SelectItem>
                                </SelectContent>
                              </Select>
                              {isClaudeGenerating && (
                        ...
                        <div className="text-center py-8 sm:py-12 text-muted-foreground">
                          ...
                          <p className="text-sm sm:text-base mb-4 max-w-md mx-auto">
                            Generate enhanced meeting minutes using Claude AI for superior analysis and formatting.
                          </p>
                          <div className="space-y-3">
