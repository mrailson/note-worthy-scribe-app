...
Generated by Notewell AI Meeting Notes Service`;
  ...
  const renderFormattedText = (text: string) => {
    ...
    // Improve table formatting with less top spacing
    ...
    // Wrap table rows in proper table structure with reduced top margin
    formatted = formatted.replace(/(<tr>.*<\/tr>\s*)+/g, (match) => {
      return `<table class="w-full border-collapse border border-gray-300 mt-2 mb-4">${match}</table>`;
    });
