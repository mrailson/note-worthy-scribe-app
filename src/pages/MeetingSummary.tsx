                          ...
                          <div className="flex flex-col items-start">
                            ...
                            <div className="text-xs text-muted-foreground">
                              {(() => {
                                ...
                                console.log('🔍 Claude header - title:', title, 'date:', date, 'time:', time, 'wordCount:', wordCount);
                                console.log('🔍 Claude header - meetingData:', meetingData);
                                console.log('🔍 Claude header - meetingSettings:', meetingSettings);
                          ...
                          <div className="flex flex-col items-start">
                            ...
                            <div className="text-xs text-muted-foreground">
                              {(() => {
                                ...
                                const time = getMeetingRoundedTime();
                                const wordCount = meetingData?.wordCount ? `${(meetingData.wordCount / 1000).toFixed(1)}K` : '0';
                                console.log('🔍 Claude header 2 - title:', title, 'date:', date, 'time:', time, 'wordCount:', wordCount);
                                return `${title} • ${date} • ${time} • ${wordCount} Words - Transcript`;
                              })()}
                            </div>
                          </div>
                           ...
                           {claudeNotes && (
                            <div className="flex items-center gap-1">
                              ...
                              <Button
                                onClick={async (e) => {
                                  e.stopPropagation();
                                  console.log('🔄 Claude Edit/Save button clicked (mobile), isClaudeEditing:', isClaudeEditing);
                                  if (isClaudeEditing) {
                                    console.log('💾 Saving Claude notes (mobile), length:', claudeNotes.length);
                                    console.log('💾 Claude notes content preview (mobile):', claudeNotes.substring(0, 100));
                                    // Save the Claude notes to database
                                    await saveSummaryToDatabase(claudeNotes);
                                    toast.success("Claude notes saved successfully!");
                                  }
