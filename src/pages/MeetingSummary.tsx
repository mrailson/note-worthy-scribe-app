                ...
                <DropdownMenuGroup>
                  ...
                  <DropdownMenuSub>
                    ...
                    <DropdownMenuSubContent className="bg-white border shadow-md z-50">
                      <DropdownMenuItem onClick={() => setIsClaudeEditing(true)}>
                      ...
                      <DropdownMenuItem onClick={() => {
                        // Handle Update Names and Terms - could open a modal or panel
                        toast.info("Update Names and Terms feature coming soon!");
                      }}>
