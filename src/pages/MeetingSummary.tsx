...
export default function MeetingSummary() {
  ...
  const reprocessFromBackup = async () => {
    if (!meetingData?.id || !backupRecord) {
                ...
                {backupRecord && (
                  <div className="mt-3 flex flex-wrap gap-2">
                    <Button
                      ...
                      onClick={() => reprocessFromBackup()}
                    >
                      {isReprocessing ? (
                        <>
                          <div className="h-4 w-4 mr-2 animate-spin border border-current border-t-transparent rounded-full" />
                          Rebuilding...
                        </>
                      ) : (
                        <>
                      ...
                      {isTranscriptOpen && (meetingData?.transcript || transcriptData.length > 0) && (
                        ...
                        {backupRecord && (
                          <Button
                            ...
                            size="sm"
                            disabled={isReprocessing}
                            onClick={(e) => { e.stopPropagation(); reprocessFromBackup(); }}
                            className="text-xs"
                          >
                            {isReprocessing ? (
                              <>
