                        ...
                        <span className="flex items-center gap-2">
                          ...
                          <div className="flex flex-col items-start">
                            ...
                            <div className="text-xs text-muted-foreground">
                              {meetingData?.title || meetingSettings?.title || 'Meeting'} • {getMeetingDate()} • {getMeetingRoundedTime()} • {meetingData?.wordCount ? `${(meetingData.wordCount / 1000).toFixed(1)}K` : '0'} Words - Transcript
                            </div>
                          </div>
                        </span>
                        <div className="flex items-center gap-2">
