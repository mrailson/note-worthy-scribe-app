        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-xl md:text-3xl font-bold text-foreground">{meetingData.title}</h1>
              <p className="text-sm md:text-base text-muted-foreground">NHS Meeting Summary & Minutes</p>
            </div>
          </div>
          <div className="flex flex-col gap-2 md:flex-row md:items-center">
            ...
            <Button variant="outline" onClick={continueMeeting} size="sm" className="w-full md:w-auto">
