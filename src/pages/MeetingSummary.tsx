        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="hidden md:flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Desktop Email Button - Only show on desktop and when content exists */}
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <Button 
                ...
                variant={aiGeneratedMinutes ? "outline" : "default"}
              >
              ...
              {/* Mobile Email Button - Show immediately after AI generation */}
              {aiGeneratedMinutes && aiGeneratedMinutes.trim().length > 0 && (
                    ...
                    <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col">
                      ...
                      <div className="md:hidden mb-4 pb-4 border-b">
                        <Button 
                          ...
                          disabled={isEmailLoading || !userEmail}
                          className="w-full"
                        >
                          <Mail className="h-4 w-4 mr-2" />
                          {isEmailLoading ? 'Sending...' : 'Send Email'}
