                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <Alert className="border-green-200 bg-green-50">
                          ...
                          <AlertTitle>Safety Case Summary</AlertTitle>
                          <AlertDescription>
                            The Notewell system has been designed and implemented with comprehensive safety controls. 
                            The clinical safety case demonstrates that risks have been reduced to an acceptable level through 
                            systematic application of risk management principles.
                          </AlertDescription>
                        </Alert>
