...
export const useMeetingInfographic = () => {
  ...
  const sanitiseCustomStyleRequest = (rawStyle: string): string => {
    ...
    const franchiseMappings: Record<string, string> = {
      ...
      'simpsons': 'Springfield cartoon family theme: bright yellow characters, suburban Americana, satirical Americana, donut and Duff beer motifs, chunky black outlines, four-finger animation style, Simpsons yellow (#FED90F)',
      'the simpsons': 'Springfield cartoon family theme: bright yellow characters, suburban Americana, satirical Americana, donut and Duff beer motifs, chunky black outlines, four-finger animation style, Simpsons yellow (#FED90F)',
      'family guy': 'Quahog animated sitcom theme: crude humour, cutaway gag style, bright primary colours, Peter Griffin aesthetic, irreverent comedy',
      'south park': 'construction paper animation theme: crude cutout style, Colorado mountain town, satirical edge, Kenny and friends, deliberately simple animation',
      'futurama': 'retro sci-fi cartoon theme: year 3000 New New York, Planet Express delivery, robot and human comedy, Bender aesthetic, space adventure',
      'bobs burgers': 'family restaurant cartoon theme: warm burger joint, Belcher family, quirky comedy, handwritten signage, Brooklyn vibes',
      'archer': 'spy cartoon theme: mid-century modern aesthetic, Sterling Archer, danger zone, sleek retro styling, adult animated comedy',
      'rick and morty': 'interdimensional adventure theme: portal green, chaotic multiverse, mad scientist and grandson, sci-fi cartoon, burp humour',
      'gravity falls': 'mystery cartoon theme: Oregon woodland, monster-of-the-week, sibling adventure, cipher codes, Disney XD magic',
      'adventure time': 'Land of Ooo theme: candy kingdom colours, Finn and Jake aesthetic, surreal landscapes, mathematical adventure',
      'regular show': 'slacker cartoon theme: park worker aesthetic, Mordecai and Rigby, 80s pop culture references, everyday situations gone wild',
      'steven universe': 'Crystal Gems theme: gem warriors, Beach City, pastel colours, inclusive themes, magical girl influences',
      'avatar last airbender': 'elemental bending theme: four nations, Asian-inspired world, martial arts, Aang journey, anime-influenced animation',
      'avatar the last airbender': 'elemental bending theme: four nations, Asian-inspired world, martial arts, Aang journey, anime-influenced animation',
      'legend of korra': 'Republic City theme: 1920s Asian-inspired steampunk, bending sports, Korra journey, sequel series aesthetics',
      'spongebob': 'Bikini Bottom theme: underwater pineapple, jellyfish fields, Krabby Patty, nautical nonsense, absurdist humour',
      'spongebob squarepants': 'Bikini Bottom theme: underwater pineapple, jellyfish fields, Krabby Patty, nautical nonsense, absurdist humour',
      'fairly oddparents': 'fairy godparent theme: Da Rules magic, Timmy Turner wishes, bright Nickelodeon colours, Cosmo and Wanda pink and green',
      'jimmy neutron': 'boy genius theme: Retroville aesthetic, science experiments, big brain, early 2000s CGI, blast off rocket',
      'dexters lab': 'secret laboratory theme: boy genius, Dee Dee chaos, Hanna-Barbera style, science vs sister',
      'powerpuff girls': 'Chemical X superhero theme: sugar spice and everything nice, Townsville, girl power, bright and punchy colours',
      'samurai jack': 'Genndy Tartakovsky theme: minimal dialogue, cinematic framing, feudal Japan meets future, stylised action',
      'courage the cowardly dog': 'Nowhere Kansas horror theme: scary cartoon, Eustace and Muriel, surreal scares, purple dog',
      'fosters home': 'imaginary friends theme: Fosters Home for Imaginary Friends, colourful chaos, creative creature designs',
      'codename kids next door': 'kid spy treehouse theme: KND numbering, 2x4 technology, anti-adult missions, operation codenames',
      'teen titans': 'teenage superhero theme: Jump City, anime-influenced DC, serious action, Robin and team',
      'teen titans go': 'wacky superhero comedy theme: chibi style, fourth wall breaking, pizza obsession, goofy DC parody',
      'phineas and ferb': 'summer vacation invention theme: backyard rollercoasters, Perry the Platypus, Doofenshmirtz, catchy songs',
      'bluey': 'Australian family cartoon theme: Brisbane heeler dogs, imaginative play, heartfelt parenting, gentle Aussie humour, bluey blue colours',
      'peppa pig': 'British preschool theme: muddy puddles, pink pig family, simple animation, cheerful narration',
      'paw patrol': 'rescue pup theme: Adventure Bay, helpful dogs, Chase and friends, preschool action, bright primary colours',
      'cocomelon': 'nursery rhyme theme: baby JJ, bright educational colours, simple animation, repetitive songs',
      'scooby doo': 'mystery solving theme: Mystery Machine van, zoinks and jinkies, masked villains, Scooby snacks, groovy 60s colours',
      'looney tunes': 'classic cartoon chaos theme: Bugs Bunny, Thats All Folks, Acme products, slapstick comedy, Warner Bros golden age',
      'tom and jerry': 'cat and mouse chase theme: slapstick violence, MGM classic, no dialogue, eternal pursuit',
      'mickey mouse': 'Disney classic theme: red shorts and white gloves, cheerful optimism, magical kingdom, Disney magic',
      'donald duck': 'Disney sailor theme: blue sailor suit, temper tantrums, quacking comedy, Duckburg adventures',
      'winnie the pooh': 'Hundred Acre Wood theme: honey pots, gentle woodland, Pooh and friends, cosy comfort, AA Milne charm',
      'bambi': 'forest wildlife theme: woodland deer, nature beauty, Disney classic, circle of life',
      'dumbo': 'circus elephant theme: big ears flight, pink elephants, mother love, Disney classic heartbreak',
      'jungle book': 'Indian jungle theme: Mowgli and Baloo, bare necessities, Shere Khan danger, Disney musical adventure',
      'aristocats': 'Parisian cat theme: sophisticated felines, jazz music, Edgar the butler, 1910s France',
      'robin hood': 'Disney fox outlaw theme: medieval England, steal from the rich, fox and bear duo, archery adventure',
      '101 dalmatians': 'spotty puppy theme: Cruella de Vil, dalmatian dots, London adventure, puppy rescue',
      'lady and the tramp': 'romantic dog theme: spaghetti dinner, 1909 Americana, class differences, Disney romance',
      'little mermaid': 'under the sea theme: Ariel the mermaid, Atlantica kingdom, Sebastian and Flounder, part of your world',
      'hercules': 'Greek mythology Disney theme: zero to hero, Olympus gods, Hades sass, gospel choir, ancient Greece',
      'hunchback': 'Notre Dame theme: Paris cathedral, Quasimodo, dark Disney, sanctuary bells, Frollo villainy',
      'pocahontas': 'Native American Disney theme: Jamestown 1607, colours of the wind, Meeko and Flit, river and forest',
      'tarzan': 'jungle man theme: Phil Collins soundtrack, tree surfing, ape family, two worlds',
      'lilo and stitch': 'Hawaiian alien theme: ohana means family, Experiment 626, surfing and Elvis, island warmth',
      'emperors new groove': 'Incan comedy theme: llama transformation, no touchy, Kuzco sass, Kronk comedy',
      'atlantis': 'lost city adventure theme: 1914 expedition, underwater civilization, Milo scholar, Disney sci-fi',
      'treasure planet': 'space pirate theme: Jim Hawkins, Long John Silver cyborg, cosmic sailing, steampunk Disney',
      'big hero 6': 'San Fransokyo superhero theme: Baymax healthcare robot, tech heroes, Japanese-American fusion, fist bump',
      'zootopia': 'mammal metropolis theme: Judy Hopps bunny cop, predator and prey, city diversity, try everything',
      'wreck it ralph': 'video game world theme: arcade adventure, villain with heart, Sugar Rush racing, game hopping',
      'bolt': 'TV dog hero theme: Hollywood to heartland, Mittens and Rhino, real adventure, pet journey',
      'meet the robinsons': 'future family theme: time travel, keep moving forward, quirky inventors, Disney optimism',
