  ...
  const performLiveMerge = useCallback((
    ...
    if (assemblyRawChunks.length === 0 && whisperRawChunks.length === 0) {
      return { 
        transcript: '', 
        wordCount: 0, 
        stats: { whisperChunks: 0, assemblyChunks: 0, deepgramChunks: 0, keptCount: 0, droppedCount: 0, overlapConflicts: 0, bufferedDrops: 0, dedupInputCount: 0, dedupOutputCount: 0, dedupDropped: 0, dedupTrimmed: 0, dedupBlockedByGuard: 0 },
        kept: [],
        dropped: []
      };
    }
