...
import { ChevronDown, ChevronRight, Shield, ShieldCheck, Landmark, Search, HelpCircle, Settings, Calendar as CalendarIcon, Eye, Mic, Square, Plus, Trash2, X, FileText, Loader2, ZoomIn, ZoomOut } from 'lucide-react';
...
function InlineInvoicePdfPreview({ pdfData }: { pdfData: ArrayBuffer | null }) {
