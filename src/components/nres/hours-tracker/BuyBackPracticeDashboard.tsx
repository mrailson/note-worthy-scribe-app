      ...
      {expanded && (
        <div style={{ borderTop: '1px solid #f3f4f6', padding: '0 18px 18px' }}>
          ...
          {(() => {
            ...
            const mgmtBreakdown = (() => {
              const mgmtLine = staffDets.find((s: any) => s.staff_category === 'management' || s.staff_role === 'NRES Management');
              ...
              <div style={{ margin: '12px 0 0' }}>
                {mgmtBreakdown && (
                  <div style={{ padding: '10px 14px', marginBottom: 10, borderRadius: 8, background: '#eff6ff', border: '1px solid #bfdbfe', fontSize: 12, color: '#1e40af', display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
                    ...
                    <span>= <strong>£{mgmtBreakdown.total.toLocaleString('en-GB', { minimumFractionDigits: 2 })}</strong></span>
                  </div>
                )}
                <div style={{ overflowX: 'auto' }}>
