...
export const SpeakerModeSelector: React.FC<SpeakerModeSelectorProps> = ({
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div className={cn(
        "w-[80%] h-[2px] rounded-full transition-all duration-300",
        mode === 'staff' 
          ? "bg-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.6),0_0_30px_rgba(59,130,246,0.3)]"
          : "bg-emerald-400 shadow-[0_0_15px_rgba(16,185,129,0.6),0_0_30px_rgba(16,185,129,0.3)]"
      )} />
      ...
      <p className="text-center text-sm text-muted-foreground">
        {isListening 
          ...
          : 'Click the Blue Circle Microphone button to speak and start translation (start speaking when it turns red)'
        }
      </p>
    </div>
  );
