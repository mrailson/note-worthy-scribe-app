...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "touch-manipulation select-none pointer-events-auto sm:min-w-[8rem] min-w-[12rem] max-h-[50vh] overflow-y-auto",
      className
    )}
    {...props}
  />
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile optimizations - prevent bleeding and off-screen issues
        "touch-manipulation select-none overscroll-none",
        // Ensure dropdown stays within viewport
        "max-w-[calc(100vw-1rem)] sm:max-w-none",
        // Responsive sizing that respects trigger width
        "sm:min-w-[8rem] w-full sm:w-auto max-h-[40vh] overflow-y-auto",
        className
      )}
      {...props}
    />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "touch-manipulation min-h-[44px] sm:py-1.5 sm:min-h-auto",
      inset && "pl-8",
      className
    )}
    {...props}
