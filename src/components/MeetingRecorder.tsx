    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="recorder" className="w-full">
        <TabsList className="grid w-full grid-cols-6">
          ...
          <TabsTrigger value="test-recorder" className="flex items-center gap-2">
            <Mic className="h-4 w-4" />
            <span className="hidden sm:inline">Test Meeting Recorder</span>
        ...
        {/* Test Meeting Recorder Tab - Identical to Meeting Recorder Tab */}
        <TabsContent value="test-recorder" className="space-y-6 mt-6">
          <div className="space-y-4">
            {/* Compact Stats Dashboard */}
            <Card className="bg-gradient-to-br from-background to-muted/30">
              <CardContent className="pt-4 pb-4">
