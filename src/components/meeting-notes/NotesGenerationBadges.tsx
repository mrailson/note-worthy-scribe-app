...
import { Brain, FileText, ShieldCheck, Download } from 'lucide-react';
...
export const NotesGenerationBadges: React.FC<NotesGenerationBadgesProps> = ({ metadata, meetingTitle }) => {
  ...
  const qcBadgeClass = () => {
    ...
    if (qcStatus === 'failed' || qcStatus === 'error') return 'bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950/30 dark:text-amber-300 dark:border-amber-800';
