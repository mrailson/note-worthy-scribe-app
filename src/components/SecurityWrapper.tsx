...
export const SecurityWrapper = ({ children }: SecurityWrapperProps) => {
  useEffect(() => {
    ...
    const cspHeader = [
      ...
      "connect-src 'self' https://dphcnbricafkbtizkoal.supabase.co wss://dphcnbricafkbtizkoal.supabase.co https://api.openai.com",
      "media-src 'self' blob:",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
