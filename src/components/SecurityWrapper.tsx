...
export const SecurityWrapper = ({ children }: SecurityWrapperProps) => {
  ...
  return (
    <>
      <Helmet>
        <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: data: https://cdn.gpteng.co https://cdn.jsdelivr.net https://unpkg.com https://cdnjs.cloudflare.com https://*.googleadservices.com https://*.google.com https://*.gstatic.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.gstatic.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https: blob:; connect-src 'self' https://dphcnbricafkbtizkoal.supabase.co wss://dphcnbricafkbtizkoal.supabase.co https://api.openai.com https://api.assemblyai.com wss://api.assemblyai.com https://api.deepgram.com wss://api.deepgram.com https://lovable-api.com wss://lovable-api.com https://*.plausible.io https://api.elevenlabs.io wss://api.elevenlabs.io; media-src 'self' blob: https://dphcnbricafkbtizkoal.supabase.co; frame-src 'self' https://dphcnbricafkbtizkoal.supabase.co; object-src 'none'; base-uri 'self'; form-action 'self'; upgrade-insecure-requests;" />
