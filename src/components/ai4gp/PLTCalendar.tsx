...
export const PLTCalendar: React.FC<PLTCalendarProps> = ({ compact = false, onDateClick }) => {
  ...
  return (
    <div className={cn(
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-pink-500 to-fuchsia-600 px-4 py-3 flex items-center gap-2">
