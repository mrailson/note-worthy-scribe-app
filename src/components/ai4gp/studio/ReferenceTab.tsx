  ...
  return (
    <div className="space-y-6">
      ...
      {settings.referenceImages.length > 0 && (
        <div className="space-y-3">
          <Label>Uploaded References ({settings.referenceImages.length})</Label>
      ...
      <div className="space-y-2">
        <Label htmlFor="refInstructions" className="flex items-center gap-2">
          <Pencil className="h-4 w-4" />
          Instructions (what to change/create)
        </Label>
        <Textarea
          id="refInstructions"
          placeholder="e.g., 'Change the background to blue', 'Make it landscape', 'Add flu vaccination messaging'..."
