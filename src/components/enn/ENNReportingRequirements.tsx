...
const ENNReportingComprehensive = () => {
  ...
  const renderOverview = () => (
    <div className="space-y-6">
      <SectionHeader 
        ...
        subtitle="Understanding the ENN SDA contract structure, governance, and reporting framework"
        icon={FileText}
      />
  ...
  const renderInnovator = () => (
    <div className="space-y-6">
      ...
      <ExplainerBox title="Innovator Status" type="icb" requirementId="innovator-learning">
        <p>As an Innovator site, ENN has additional obligations beyond standard service delivery. These are designed to support the ICB in extending the programme to other neighbourhoods.</p>
      </ExplainerBox>
...
export default ENNReportingComprehensive;
