      ...
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-5">
          <div className="flex items-center justify-between mb-1">
            <div>
              <h2 className="text-xl font-bold text-[#003087]">ENN New Models — ICB Contractual & Reporting Requirements Overview</h2>
              <p className="text-sm text-slate-500">Operational tools and reference documents</p>
            </div>
            <p className="text-xs text-slate-400">Last updated: 4 April 2026</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            { border: "#10B981", label: "OPERATIONS TOOL", value: "Excel V1.0 — Pending", subtitle: "To be configured for ENN" },
            { border: "#F59E0B", label: "TARGET GO-LIVE", value: "3 Months", subtitle: "From 4 April 2026" },
            { border: "#7C3AED", label: "MANAGED BY", value: "Rebecca Gane", subtitle: "ENN Transformation Manager · 3Sixty Care Partnership" },
            { border: "#2563EB", label: "PRACTICES", value: "10 (3 Hubs)", subtitle: "Harborough Field · The Cottons · The Meadows" },
          ].map((card, i) => (
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-5 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap mb-1">
                <h3 className="font-bold text-[15px] text-slate-900">ENN SDA Rota Management and Buy Back Resource Workbook V1.0</h3>
                ...
                <Button variant="outline" size="sm" asChild>
                  <a href="/documents/ENN_SDA_Rota_Management_V1_0.xlsx" download>
                    <Download className="h-3.5 w-3.5 mr-1" />
                    Download Excel
                  </a>
                </Button>
              </div>
              <p className="text-sm text-slate-500">The operational tool for ENN service management from 1st April 2026</p>
            </div>
          </div>

          {/* Body text */}
          <p className="text-sm text-slate-600 leading-relaxed">
            The Managerial Lead will manage this workbook centrally, populating it directly where possible and working with practices to gather any data they can't source themselves. Formula-driven across 20 tabs with full open book financials visible to the ENN board and ICB.
          </p>
          ...
          <div className="bg-white rounded-lg p-4 space-y-3 border border-slate-200">
            ...
            <div className="flex justify-end pt-1">
              <Button variant="outline" size="sm" asChild>
                <a href="/documents/ENN_Excel_Operational_Resource_Analysis.docx" download>
                  <Download className="h-3.5 w-3.5 mr-1" />
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="border border-slate-200 rounded-lg p-4">
            <h3 className="font-semibold text-slate-900 mb-3">Exhibit 1: System Configuration (ENN Mapping)</h3>
            <img 
              src={gpConnectSystmoneConfig} 
              alt="SystmOne GP Remote Booking - ENN SDA configuration showing available rotas at Harborough Field Surgery"
              className="w-full rounded-lg border border-slate-200 shadow-sm cursor-pointer hover:opacity-90 transition-opacity"
              onClick={() => setLightboxImage({ src: gpConnectSystmoneConfig, alt: "SystmOne GP Remote Booking", title: "Exhibit 1 - System Configuration (ENN Mapping)" })}
            />
          </div>
          ...
          <div className="border border-slate-200 rounded-lg p-4">
            ...
            <img 
              ...
              alt="EMIS Web GP Connect Appointments - Cross-provider booking at Harborough Field Surgery showing ENN SDA appointments"
              className="w-full rounded-lg border border-slate-200 shadow-sm cursor-pointer hover:opacity-90 transition-opacity"
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="border border-slate-200 rounded-lg p-4">
            ...
            <img 
              src="/images/enn-risk-stratification.png" 
              alt="ENN SDA Hub Risk Stratification Overview showing RED, AMBER, GREEN patient categories and practice discretionary exemptions"
              className="w-full rounded-lg border border-slate-200 shadow-sm cursor-pointer hover:opacity-90 transition-opacity"
              onClick={() => setLightboxImage({ src: "/images/enn-risk-stratification.png", alt: "Risk Stratification Overview", title: "Exhibit 3 - Risk Stratification Framework" })}
            />
          </div>
          <div className="border border-slate-200 rounded-lg p-4 flex flex-col">
            ...
            <div className="space-y-3 text-sm text-slate-700 flex-1">
              <p>Strategic approach to protecting vulnerable patients and optimising service utilisation across the ENN SDA Hub.</p>
              <div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-200 flex flex-wrap gap-2">
              <Button variant="outline" size="sm" asChild>
                <a href="/documents/ENN_Risk_Stratification_Overview.docx" download>
      ...
      >
        <div className="space-y-6">
          ...
          <div className="border-t border-slate-200 pt-4">
            <h4 className="font-semibold text-slate-900 mb-3">Practice System Breakdown — by Hub</h4>
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mb-4 text-xs text-amber-800">
              <strong>⚠️ Clinical system confirmation pending</strong> — Practice Managers to confirm EMIS/SystmOne status via the ENN Setup Briefing document.
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border-t-4 border-[#005EB8]">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-3 h-3 rounded-full bg-[#005EB8]"></div>
                  <h5 className="font-semibold text-slate-900">Harborough Field Hub</h5>
                </div>
                <p className="text-xs text-slate-500 mb-2">42,315 patients · 5 practices</p>
                <ul className="text-sm text-slate-600 space-y-1 ml-5">
                  <li><strong>Harborough Field Surgery</strong> (Hub)</li>
                  <li>Oundle Medical Practice</li>
                  <li>Rushden Medical Centre</li>
                  <li>Parklands Medical Centre</li>
                  <li>Nene Valley Surgery</li>
                </ul>
              </div>
              <div className="bg-emerald-50 rounded-lg p-4 border-t-4 border-emerald-600">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-3 h-3 rounded-full bg-emerald-600"></div>
                  <h5 className="font-semibold text-slate-900">The Cottons Hub</h5>
                </div>
                <p className="text-xs text-slate-500 mb-2">24,065 patients · 3 practices</p>
                <ul className="text-sm text-slate-600 space-y-1 ml-5">
                  <li><strong>The Cottons Medical Centre</strong> (Hub)</li>
                  <li>Spinney Brook Medical Centre</li>
                  <li>Marshalls Road Surgery</li>
                </ul>
              </div>
              <div className="bg-orange-50 rounded-lg p-4 border-t-4 border-orange-500">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-3 h-3 rounded-full bg-orange-500"></div>
                  <h5 className="font-semibold text-slate-900">The Meadows Hub</h5>
                </div>
                <p className="text-xs text-slate-500 mb-2">23,861 patients · 2 practices</p>
                <ul className="text-sm text-slate-600 space-y-1 ml-5">
                  <li><strong>The Meadows Surgery</strong> (Hub)</li>
                  <li>Higham Ferrers Surgery</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="bg-purple-50 rounded-lg p-4">
            <p className="text-sm text-slate-700">
              <strong>Hardware Access:</strong> All 10 practices clinical systems are accessible via standard Ardem & Gem Build Laptops with always-on VPN configuration.
            </p>
          </div>
        </div>
      </CollapsibleCard>
          ...
          <div className="border-l-4 border-green-500 pl-4">
            ...
            <div className="ml-7 space-y-4">
              <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                <div className="flex items-center gap-2 mb-2">
                  <Badge className="bg-amber-500">PENDING — ENN Setup</Badge>
                </div>
                <div className="space-y-3 text-sm text-slate-700">
                  <p>
                    <strong>Current Status:</strong> Telephony platform status to be confirmed across all 10 ENN practices.
                  </p>
                  <p>
                    <strong>Action Required:</strong> Survey each practice to confirm current telephony provider and assess cross-hub booking compatibility.
                  </p>
                  <p>
                    <strong>Owner:</strong> Rebecca Gane / 3Sixty Care Partnership
                  </p>
                </div>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-4 border border-green-300">
                <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                  ...
                  <a 
                    href="/documents/X-ON_Intelligent_Care_Navigation_Proposal_ENN.pdf" 
                    download="X-ON_Intelligent_Care_Navigation_Proposal_ENN.pdf"
                ...
                <div className="bg-white rounded-lg p-3 mb-3 border border-green-200">
                  ...
                  <ul className="text-sm text-slate-700 space-y-1">
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" />
                      <span>X-ON will fund <strong>ENN telephony alignment</strong> (£6,434.79 inc. VAT)</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-600 flex-shrink-0" />
                ...
                <div className="flex items-center gap-3 p-3 bg-blue-100 rounded-lg border border-blue-300 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-700 text-xs">(~£6,854/month for 10 practices)</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                ...
                <p className="text-xs text-slate-500 mt-2 italic">Note: Telephony alignment for ENN practices — status TBC</p>
              </div>
              ...
              <div className="bg-amber-50 rounded-lg p-3 border border-amber-200">
                ...
                <ul className="text-sm text-amber-800 space-y-1 list-disc ml-4">
                  ...
                  <li>Formal evaluation against ENN requirements</li>
