// Edge Function Audit — Data Registry
// Contains all active and archived function entries with manual overrides.
// Each entry is enriched via enrichFunction() to populate computed governance fields.

import type { BaseEdgeFunction } from './EdgeFunctionAuditTypes';
import type { EdgeFunction } from './EdgeFunctionAuditTypes';
import { enrichFunction } from './EdgeFunctionAuditUtils';

// ── Active Functions Registry ───────────────────────────────────────────

const RAW_ACTIVE_FUNCTIONS: Omit<BaseEdgeFunction, 'status'>[] = [
  ...
  { name: 'fetch-gp-news', purpose: 'Fetches latest GP practice news', referencedInClient: true, referencedInOtherFunctions: false, hasConfigEntry: true, calledFrom: '/ (Home)', dataSensitivityOverride: 'Public' },
  ...
  { name: 'get-client-info', purpose: 'Returns client connection information', referencedInClient: true, referencedInOtherFunctions: false, hasConfigEntry: true, calledFrom: '/network-diagnostics (NetworkDiagnostics)', dataSensitivityOverride: 'Public' },
  ...
  { name: 'import-icb-formulary-seed', purpose: 'Seeds initial ICB formulary data (ARCHIVED)', referencedInClient: false, referencedInOtherFunctions: false, hasConfigEntry: false, calledFrom: 'Archived — one-off seed script' },
  ...
  { name: 'nhs-gp-news', purpose: 'Fetches NHS GP-specific news', referencedInClient: true, referencedInOtherFunctions: false, hasConfigEntry: true, calledFrom: '/ (Home)', dataSensitivityOverride: 'Public' },
  ...
  { name: 'parse-bp-readings', purpose: 'Parses blood pressure readings from text', referencedInClient: true, referencedInOtherFunctions: false, hasConfigEntry: true, calledFrom: '/bp-calculator (BPCalculator)', dataSensitivityOverride: 'Public' },
...
// ── Archived Functions Registry ─────────────────────────────────────────

const RAW_ARCHIVED_FUNCTIONS: Omit<BaseEdgeFunction, 'status'>[] = [
  ...
  { name: 'generate-image', purpose: 'Generic image generation (replaced)', referencedInClient: false, referencedInOtherFunctions: false, hasConfigEntry: false, calledFrom: 'N/A (archived)', replacementExists: true, replacementReference: 'advanced-image-generation' },
  ...
  { name: 'gpt5-clinical-reviewer', purpose: 'GPT-5 clinical review (replaced)', referencedInClient: false, referencedInOtherFunctions: false, hasConfigEntry: false, calledFrom: 'N/A (archived)', replacementExists: true, replacementReference: 'gpt5-fast-clinical' },
  ...
  { name: 'meeting-completion-handler', purpose: 'Meeting completion handler (replaced)', referencedInClient: false, referencedInOtherFunctions: false, hasConfigEntry: false, calledFrom: 'N/A (archived)', replacementExists: true, replacementReference: 'meeting-completion-processor' },
  ...
  { name: 'openai-realtime-token', purpose: 'OpenAI realtime token (replaced)', referencedInClient: false, referencedInOtherFunctions: false, hasConfigEntry: false, calledFrom: 'N/A (archived)', replacementExists: true, replacementReference: 'openai-realtime-session' },
  ...
  { name: 'smart-web-search', purpose: 'Smart web search (replaced)', referencedInClient: false, referencedInOtherFunctions: false, hasConfigEntry: false, calledFrom: 'N/A (archived)', replacementExists: true, replacementReference: 'smart-source-router' },
...
// ── Pre-enriched exports ────────────────────────────────────────────────

export const ACTIVE_FUNCTIONS: EdgeFunction[] = RAW_ACTIVE_FUNCTIONS.map(f =>
  enrichFunction({ ...f, status: 'active' })
);

export const ARCHIVED_FUNCTIONS: EdgeFunction[] = RAW_ARCHIVED_FUNCTIONS.map(f =>
  enrichFunction({ ...f, status: 'archived' })
);
