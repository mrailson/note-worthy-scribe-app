...
import { practices, statusConfig, calculatePracticeTotals } from '@/data/nresRecruitmentData';
...
const NRESWorkforceRecruitmentTracker = () => {
  ...
  // Wrap shared calculatePracticeTotals to pass seasonFilter
  const calculatePracticeTotalsLocal = (practice) => calculatePracticeTotals(practice, seasonFilter);
