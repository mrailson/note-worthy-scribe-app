...
export const allCandidates: ACPCandidate[] = [
  ...
  },
  {
    ...
    score: 38,
    registration: 'NMC',
    registrationDetails: 'Mental Health Nursing',
    mscStatus: 'Completed (Mental Health Focus)',
    prescriber: 'Non-medical prescriber (mental health)',
    currentRole: 'Mental Health Practitioner',
    acpExperience: '2 years (mental health setting)',
    settings: ['Community Mental Health Team', 'Crisis Team'],
    keyRoles: ['Mental health assessments', 'Crisis intervention', 'Medication management'],
    scoringBreakdown: [
      { criterion: 'Professional Registration', maxScore: 10, score: 10, evidence: 'NMC registered MH Nurse' },
      { criterion: 'MSc Advanced Practice', maxScore: 10, score: 5, evidence: 'MSc but mental health specific, not general ACP' },
      { criterion: 'V300 Prescriber', maxScore: 10, score: 5, evidence: 'Prescriber but MH formulary only' },
      { criterion: 'ACP Experience', maxScore: 10, score: 3, evidence: 'MH ACP experience, not transferable to general practice' },
      { criterion: 'Primary Care Experience', maxScore: 10, score: 2, evidence: 'No primary care experience' },
      { criterion: 'Clinical Skills', maxScore: 10, score: 3, evidence: 'MH skills only, limited physical assessment' },
      { criterion: 'Leadership', maxScore: 10, score: 5, evidence: 'Some team leadership' },
      { criterion: 'Teaching/Mentoring', maxScore: 10, score: 3, evidence: 'Limited' },
      { criterion: 'Flexibility', maxScore: 10, score: 2, evidence: 'Limited to MH settings' },
      { criterion: 'NHS Systems', maxScore: 10, score: 0, evidence: 'No primary care systems knowledge' },
    ],
    strengths: ['Strong mental health expertise'],
    concerns: ['Wrong specialism - mental health focus does not transfer to general primary care ACP role', 'No physical health assessment skills', 'No primary care experience'],
    interviewQuestions: [],
    recommendation: 'do-not-shortlist',
    recommendationReason: 'Specialism mismatch: Mental health ACP background does not meet requirements for general practice ACP role.',
  },
  {
    id: 'ACP-2026-007',
    score: 42,
