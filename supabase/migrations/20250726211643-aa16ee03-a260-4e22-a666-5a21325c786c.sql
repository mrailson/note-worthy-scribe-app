-- First, create practice_details entry for Oak Lane Medical Practice  
...
-- Now update the gp_signature_settings references
...
-- Finally, remove the old Saxon Spires practice details
