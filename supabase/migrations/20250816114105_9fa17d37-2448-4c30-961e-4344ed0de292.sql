-- Create sample staff members for the Enhanced Access demo
...
SELECT name, day_of_week, start_time, end_time, required_role::staff_role, location, is_active FROM (VALUES
