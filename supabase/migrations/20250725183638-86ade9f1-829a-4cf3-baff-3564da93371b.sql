...
SELECT c.id,
CASE 
  WHEN c.patient_name = 'Lisa Thompson' AND c.status = 'response_sent' THEN 'Dear Ms Thompson, We sincerely apologize for the unprofessional service you received. The staff member has been retrained and we have implemented new procedures. We would welcome you back and ensure this does not happen again.'
END,
'00000000-0000-0000-0000-000000000001',
false
FROM complaints c
