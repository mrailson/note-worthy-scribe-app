-- Create sample staff members for the Enhanced Access demo with proper enum casting
...
-- Create sample shift templates with proper enum casting
INSERT INTO public.shift_templates (name, day_of_week, start_time, end_time, required_role, location, is_active) 
SELECT name, day_of_week, start_time, end_time, required_role::staff_role, location::shift_location, is_active FROM (VALUES
