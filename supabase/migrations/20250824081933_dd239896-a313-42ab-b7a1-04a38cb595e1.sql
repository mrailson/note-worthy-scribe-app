-- Insert Insuject formulary data (providing both old and new column names)
INSERT INTO public.icb_formulary (drug_name, name, name_norm, bnf_chapter, prior_approval_required, prior_approval_pdf_url, prior_approval_page_ref, last_reviewed, source)
VALUES ('Insuject', 'Insuject', 'insuject', '06 - Endocrine system', true,
