-- Fix get_meeting_usage_report to use meetings_archive (deleted meetings) and keep existing return shape
...
-- Also return more accurate start/end times for hover (prefer start_time/end_time)
