...
BEGIN
    -- Only system admins can execute this function (skip check if no user context)
    IF p_assigned_by IS NOT NULL AND NOT is_system_admin(p_assigned_by) THEN
    ...
    -- Log the bulk assignment if we have a user context
