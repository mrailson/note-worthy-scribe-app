...
-- Recreate the function using status = 'completed' instead of is_complete = true
...
BEGIN
  ...
  meeting_stats AS (
    SELECT 
      m.user_id,
      -- Use CURRENT_DATE for "today" instead of 24 hours rolling window
      ...
      -- Use CURRENT_DATE for duration and words as well
...
-- Create function to get today's meetings with details for hover tooltips
