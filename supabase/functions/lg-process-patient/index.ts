...
function buildSummaryEmailHtml(
  ...
  html += `
      ...
      <p style="color: #666; font-size: 12px; text-align: center;">
        Full report attached as Word document. PDF full report with all images scanned is available via your login at <a href="https://gpnotewell.co.uk" style="color: #005EB8;">https://gpnotewell.co.uk</a><br><br>
